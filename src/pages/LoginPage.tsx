  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col justify-between">
      ...
      <main className="flex-1 flex items-center justify-center p-3 sm:p-6">
        <div className={`w-full bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-[#E5E7EB] overflow-hidden transition-all duration-300 ${
          tab === 'cadastro' ? 'max-w-2xl' : 'max-w-md'
        }`}>
          
          {/* Header do Card (Areia Clara #F9F1E7) */}
          <div className="bg-[#F9F1E7] px-4 py-3 sm:py-4 text-center border-b border-[#E5E7EB]">
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center mx-auto mb-1.5 shadow-sm border border-[#E5E7EB]">
              <ShieldCheck className="w-5 h-5 text-[#FF6B35]" />
            </div>
            <h1 className="text-base sm:text-lg font-black text-[#1A1D1F] tracking-tight">
            ...
            <div className="flex bg-white/80 p-1 rounded-xl border border-[#E5E7EB] mt-3 max-w-xs mx-auto">
              <button
                type="button"
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-3">
            ...
            {erro && (
              <div className="bg-[#FEE2E2] border border-[#FCA5A5] text-[#DC2626] text-xs p-2.5 rounded-xl flex items-start gap-2">
            ...
            {sucesso && (
              <div className="bg-[#DCFCE7] border border-[#86EFAC] text-[#16A34A] text-xs p-2.5 rounded-xl flex items-start gap-2">
            ...
            {tab === 'login' ? (
              /* MODO LOGIN (1 Coluna Tradicional Compacta) */
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 text-sm rounded-xl border border-[#E5E7EB] focus:border-[#FF6B35] focus:ring-2 focus:ring-[#FF6B35]/20 outline-none text-[#1A1D1F]"
                    />
                  </div>
                </div>
              ...
              /* MODO NOVO OPERADOR (2 Colunas com Altura Reduzida) */
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 items-start">
                
                {/* COLUNA 1: Identificação & Acesso & Posto */}
                <div className="space-y-2.5">
                  <div>
                    ...
                    <div className="relative">
                      <UserIcon className="w-4 h-4 text-[#6B7280] absolute left-3 top-2.5" />
                      <input
                        type="text"
                        required
                        ...
                        className="w-full pl-9 pr-3 py-2 text-xs sm:text-sm rounded-xl border border-[#E5E7EB] focus:border-[#FF6B35] focus:ring-2 focus:ring-[#FF6B35]/20 outline-none text-[#1A1D1F]"
                      />
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          className="w-full pl-9 pr-3 py-2 text-xs sm:text-sm rounded-xl border border-[#E5E7EB] focus:border-[#FF6B35] focus:ring-2 focus:ring-[#FF6B35]/20 outline-none text-[#1A1D1F] bg-white"
                        >
                          {tendas.map((t) => (
                ...
                {/* COLUNA 2: Apenas Função / Nível de Acesso e Código de Autorização */}
                <div className="space-y-2.5">
                  <div>
                    <label className="block text-xs font-bold text-[#1A1D1F] mb-1">
                  ...
                  <div className="bg-[#FEF3C7] border border-[#FDE68A] p-3 rounded-xl space-y-2">
                    ...
                    <input
                      type="text"
                      required
                      placeholder="CHAVE OU CONVITE (EX: ANJOS2026)"
                    ...
                    />
                    <p className="text-[10.5px] text-[#92400E] leading-tight">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-[#FF6B35] hover:bg-[#E8531F] active:scale-[0.99] text-white font-bold text-sm rounded-xl shadow-md transition-all flex items-center justify-center gap-2 mt-1"
            >
              {loading ? (
                <>
          ...
          <div className="py-2.5 px-4 bg-[#F9FAFB] border-t border-[#E5E7EB] text-center text-[11px] text-[#6B7280]">
